...
size = 32
font = pygame.font.Font('res/Bedstead-ext.ttf', size)
...
def oParity(hx, runOnce):
	if (int(hx, 16) > 127):
		printBool("Byte with odd parity may have been detected.", runOnce)
		...
		if pCh % 2 != parity:
			printBool("Parity check passed!", runOnce)
			switch.pop(0)
